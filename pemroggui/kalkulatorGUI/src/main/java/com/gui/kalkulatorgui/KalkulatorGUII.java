 ...
 */
package com.gui.kalkulatorgui;

/**
 *
 * @author ASUS
 */
public class KalkulatorGUII extends javax.swing.JFrame {

    /**
     * Creates new form KalkulatorGUII
     */
     double nilai1, nilai2, hasil, lingkaran, alas, tinggi, sisi, keliling, luas;
    public KalkulatorGUII() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KalkulatorGUII.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KalkulatorGUII().setVisible(true);
            }
        });
    }
